		                    ...
		                    <div class="bg-secondary rounded p-4 p-sm-5 my-4 mx-3">
		                        ...
		                        <form action="${pageContext.request.contextPath}/member/modifyMember" method="post" id="modifyMemberForm">
									...
									<div class="form-floating mb-4">
			                            <input type="text" class="form-control" id="beforeName" name="beforeName" value="${loginMember.memberName}" readonly="readonly">
			                            <label for="floatingText">현재 이름</label>
			                        </div>
									<div class="form-floating mb-4">
			                            <input type="text" class="form-control" id="afterName" name="afterName">
			                            <label for="floatingText">변경할 이름</label>
			                        </div>
			                         <div class="form-floating mb-4">
			                            <input type="password" class="form-control" id="memberPw" name="memberPw">
			                            <label for="floatingPassword">Password</label>
			                        </div>
			                        <button type="button" class="btn btn-primary py-3 w-100 mb-4" id="submitBtn">Modify</button>
			                        <div>
