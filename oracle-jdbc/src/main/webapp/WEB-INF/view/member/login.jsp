	                ...
	                <div class="col-12 col-sm-8 col-md-6 col-lg-5 col-xl-4">
	                    <div class="bg-secondary rounded p-4 p-sm-5 my-4 mx-3">
	                        <div class="d-flex align-items-center justify-content-between mb-3">
	                            <a href="${pageContext.request.contextPath}/home" class="h3">
	                        ...
	                        <form action="${pageContext.request.contextPath}/member/login" method="post" id="logInForm">
		                        <div class="form-floating mb-3">
		                            <input type="text" class="form-control" id="memberId" name="memberId" placeholder="example">
		                        ...
		                        <button type="button" class="btn btn-primary py-3 w-100 mb-4" id="submitBtn">LOG IN</button>
		                        <div>
		                        	<span style="color:red;" id="errorMsg"></span>
		                        </div>
	                        </form>
	                        <p class="text-center mb-0">Don't have an Account? <a href="${pageContext.request.contextPath}/member/addMember">Sign Up</a></p>
	                    </div>
	                </div>
	            </div>
	        </div>
